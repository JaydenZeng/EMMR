...
class Dataset:
    ...
    def setdata(self, train_size):
        ...
        for i in range(len(self.keys)):
            ...
            if i < train_size-200:
            ...
            elif i>=train_size-200 and i< train_size:
                ...
                valdata['L'].append(self.label_set.index(self.label[cur_id]))
...
if __name__ == '__main__':
    ...
    traindata, valdata, testdata = data.setdata(2000)
